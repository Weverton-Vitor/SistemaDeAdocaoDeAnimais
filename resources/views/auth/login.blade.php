    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card box-login-register">
                <div class="card-header text-center box-header-login-register">{{ __('Login') }}</div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="btn btn-link" href="{{ route('password.request') }}" style="color: white;   font-size: 20px;">
