	...
	<div class="row">
		<div class="col-12">
			<form class="form" action="{{route($cvRoute.'.validarDados')}}" method="post" enctype="multipart/form-data">
				...
				<input id="nome_adotante" type="text" name="nome_adotante" class="form-control" placeholder="Nome:" value="{{old('nome_adotante')}}" required maxlength="40">
				...
				<input id="email_adotante" type="email" name="email_adotante" class="form-control" placeholder="Email:" value="{{old('email_adotante')}}" required maxlength="50">
